var dtDirectorAnnouncements = {
	...
	dtInit : function() {
		...
		// Media - Videos Gallery
			...
			jQuery('.dtdr-listings-announcements-container').each(function() {
...
jQuery(document).ready(function() {
	...
	if(!dtdrfrontendobject.elementorPreviewMode) {
		dtDirectorAnnouncements.dtInit();
	}
...
( function( $ ) {
	...
	var dtDirectorAnnouncementsJs = function($scope, $){
		dtDirectorAnnouncements.dtInit();
	};

    $(window).on('elementor/frontend/init', function(){
		if(dtdrfrontendobject.elementorPreviewMode) {
			elementorFrontend.hooks.addAction('frontend/element_ready/dtdr-widget-sp-announcements.default', dtDirectorAnnouncementsJs);
		}
	});
